...
public class Enemy : MonoBehaviour, IDamageable
{
  ...
  //     Vector3 targetVelocity = new Vector2(directionMod * 2.5f * directionMod, CurrentVelocity().y);
  ...
  //     var direction = new Vector3(transform.position.x + directionMod * 2, transform.position.y);
  ...
  //       {
  //         print("Near a wall, Turning around");
  //         StartCoroutine(StateStay(2f));
  //       }
  //     }
  //   }
